...
const translations = {
  pt: {
    ...
    story: {
      ...
      beforeDesc: 'Jardel trabalhava como assessor executivo do Marrone. O acidente foi no décimo segundo ano de parceria. Era uma carreira próspera no meio musical.',
