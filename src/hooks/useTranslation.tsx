...
const translations = {
  pt: {
    ...
    story: {
      ...
      beforeDesc: 'Jardel trabalhava como assessor exclusivo da dupla Bruno e Marrone. O acidente foi no décimo segundo ano de parceria. Era uma carreira próspera no meio musical.',
